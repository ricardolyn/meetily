...
// Re-export Tauri commands. The #[tauri::command] macro in Tauri 2.11
// generates BOTH `__cmd__<name>` and `__tauri_command_name_<name>` helper
// symbols; tauri::generate_handler!() in lib.rs needs both visible at the
// re-export path.
pub use commands::{
